...
public class map_permission extends AppCompatActivity {
    ...
    private void checkLocationSetting() {
        ...
        settingsClient.checkLocationSettings(builder.build())
                ...
                .addOnFailureListener(map_permission.this, new OnFailureListener() {
                    @Override
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                try {
                                    ...
                                    rae.startResolutionForResult(map_permission.this, GPS_UTIL_LOCATION_RESOLUTION_REQUEST_CODE);
    ...
    private LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            Intent intent = new Intent(map_permission.this, MainActivity.class);
